...
bool Reflect_obj::hasField( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","hasField",0xef8c2571,"Reflect.hasField","Reflect.hx",25,0xd5c746c1)
	HX_STACK_ARG(o,"o")
...
Dynamic Reflect_obj::field( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","field",0x54b04da9,"Reflect.field","Reflect.hx",29,0xd5c746c1)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(field,"field")
	HX_STACK_LINE(29)
	if (((o == null()))){
...
Dynamic Reflect_obj::callMethod( Dynamic o,Dynamic func,Dynamic args){
	HX_STACK_FRAME("Reflect","callMethod",0xb49e52d0,"Reflect.callMethod","Reflect.hx",46,0xd5c746c1)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(func,"func")
	HX_STACK_ARG(args,"args")
	struct _Function_1_1{
		inline static bool Block( Dynamic &func){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","Reflect.hx",47,0xd5c746c1)
			{
				HX_STACK_LINE(47)
...
bool Reflect_obj::isFunction( Dynamic f){
	HX_STACK_FRAME("Reflect","isFunction",0x0f1541d3,"Reflect.isFunction","Reflect.hx",61,0xd5c746c1)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(61)
	if (((f != null()))){
		HX_STACK_LINE(61)
...
int Reflect_obj::compare( Dynamic a,Dynamic b){
	HX_STACK_FRAME("Reflect","compare",0xa2d92b54,"Reflect.compare","Reflect.hx",65,0xd5c746c1)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(65)
	if (((a == b))){
...
bool Reflect_obj::compareMethods( Dynamic f1,Dynamic f2){
	HX_STACK_FRAME("Reflect","compareMethods",0x8b8ddd7e,"Reflect.compareMethods","Reflect.hx",68,0xd5c746c1)
	HX_STACK_ARG(f1,"f1")
	HX_STACK_ARG(f2,"f2")
	HX_STACK_LINE(69)
	if (((f1 == f2))){
...
bool Reflect_obj::isObject( Dynamic v){
	HX_STACK_FRAME("Reflect","isObject",0xd04960ba,"Reflect.isObject","Reflect.hx",76,0xd5c746c1)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(77)
	if (((v == null()))){
		HX_STACK_LINE(77)
...
bool Reflect_obj::isEnumValue( Dynamic v){
	HX_STACK_FRAME("Reflect","isEnumValue",0x97884d95,"Reflect.isEnumValue","Reflect.hx",84,0xd5c746c1)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(84)
	if (((v != null()))){
		HX_STACK_LINE(84)
...
Dynamic Reflect_obj::makeVarArgs( Dynamic f){
	HX_STACK_FRAME("Reflect","makeVarArgs",0x978955c5,"Reflect.makeVarArgs","Reflect.hx",105,0xd5c746c1)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(105)
