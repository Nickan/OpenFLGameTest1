...
{
HX_STACK_FRAME("haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","haxe/io/Path.hx",76,0x41a6c239)
HX_STACK_THIS(this)
...
::String Path_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Path","toString",0xc0ab5735,"haxe.io.Path.toString","haxe/io/Path.hx",109,0x41a6c239)
	HX_STACK_THIS(this)
	HX_STACK_LINE(109)
...
::String Path_obj::withoutDirectory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","withoutDirectory",0xdf35ce8e,"haxe.io.Path.withoutDirectory","haxe/io/Path.hx",128,0x41a6c239)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(129)
