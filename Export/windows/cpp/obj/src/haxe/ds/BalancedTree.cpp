...
{
HX_STACK_FRAME("haxe.ds.BalancedTree","new",0xfb50b0cf,"haxe.ds.BalancedTree.new","haxe/ds/BalancedTree.hx",41,0x9adadae1)
HX_STACK_THIS(this)
{
}
;
...
{
		HX_STACK_FRAME("haxe.ds.BalancedTree","set",0xfb547c11,"haxe.ds.BalancedTree.set","haxe/ds/BalancedTree.hx",50,0x9adadae1)
		HX_STACK_THIS(this)
...
Dynamic BalancedTree_obj::get( Dynamic key){
	HX_STACK_FRAME("haxe.ds.BalancedTree","get",0xfb4b6105,"haxe.ds.BalancedTree.get","haxe/ds/BalancedTree.hx",61,0x9adadae1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(62)
...
::haxe::ds::TreeNode BalancedTree_obj::setLoop( Dynamic k,Dynamic v,::haxe::ds::TreeNode node){
	HX_STACK_FRAME("haxe.ds.BalancedTree","setLoop",0xe1a32b15,"haxe.ds.BalancedTree.setLoop","haxe/ds/BalancedTree.hx",132,0x9adadae1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(k,"k")
	HX_STACK_ARG(v,"v")
...
::haxe::ds::TreeNode BalancedTree_obj::balance( ::haxe::ds::TreeNode l,Dynamic k,Dynamic v,::haxe::ds::TreeNode r){
	HX_STACK_FRAME("haxe.ds.BalancedTree","balance",0xf7f4e10b,"haxe.ds.BalancedTree.balance","haxe/ds/BalancedTree.hx",187,0x9adadae1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(l,"l")
	HX_STACK_ARG(k,"k")
	HX_STACK_ARG(v,"v")
	...
	if (((hl > (hr + (int)2)))){
		struct _Function_2_1{
			inline static int Block( ::haxe::ds::TreeNode &l){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxe/ds/BalancedTree.hx",191,0x9adadae1)
				{
					HX_STACK_LINE(191)
		...
		if (((hr > (hl + (int)2)))){
			struct _Function_3_1{
				inline static int Block( ::haxe::ds::TreeNode &r){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxe/ds/BalancedTree.hx",194,0x9adadae1)
					{
						HX_STACK_LINE(194)
...
int BalancedTree_obj::compare( Dynamic k1,Dynamic k2){
	HX_STACK_FRAME("haxe.ds.BalancedTree","compare",0x57d05c94,"haxe.ds.BalancedTree.compare","haxe/ds/BalancedTree.hx",202,0x9adadae1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(k1,"k1")
	HX_STACK_ARG(k2,"k2")
	HX_STACK_LINE(202)
