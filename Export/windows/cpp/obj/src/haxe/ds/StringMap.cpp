...
{
HX_STACK_FRAME("haxe.ds.StringMap","new",0x0f13f0c6,"haxe.ds.StringMap.new","haxe/ds/StringMap.hx",28,0xea91700a)
HX_STACK_THIS(this)
{
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxe/ds/StringMap.hx",28,0xea91700a)
			{
...
{
		HX_STACK_FRAME("haxe.ds.StringMap","set",0x0f17bc08,"haxe.ds.StringMap.set","haxe/ds/StringMap.hx",32,0xea91700a)
		HX_STACK_THIS(this)
...
Dynamic StringMap_obj::get( Dynamic _tmp_key){
	HX_STACK_FRAME("haxe.ds.StringMap","get",0x0f0ea0fc,"haxe.ds.StringMap.get","haxe/ds/StringMap.hx",36,0xea91700a)
	HX_STACK_THIS(this)
...
bool StringMap_obj::exists( ::String key){
	HX_STACK_FRAME("haxe.ds.StringMap","exists",0xd35fc136,"haxe.ds.StringMap.exists","haxe/ds/StringMap.hx",40,0xea91700a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(40)
...
bool StringMap_obj::remove( ::String key){
	HX_STACK_FRAME("haxe.ds.StringMap","remove",0x18083f9e,"haxe.ds.StringMap.remove","haxe/ds/StringMap.hx",44,0xea91700a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(44)
...
Dynamic StringMap_obj::keys( ){
	HX_STACK_FRAME("haxe.ds.StringMap","keys",0x20631ace,"haxe.ds.StringMap.keys","haxe/ds/StringMap.hx",47,0xea91700a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(48)
...
Dynamic StringMap_obj::iterator( ){
	HX_STACK_FRAME("haxe.ds.StringMap","iterator",0x40ccf7c8,"haxe.ds.StringMap.iterator","haxe/ds/StringMap.hx",53,0xea91700a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(54)
	Array< ::String > a = Array_obj< ::String >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(55)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< ::Dynamic > &me,Dynamic &it){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxe/ds/StringMap.hx",58,0xea91700a)
			{
				hx::Anon __result = hx::Anon_obj::Create();

				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_2_1,Dynamic,it)
				bool run(){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","haxe/ds/StringMap.hx",59,0xea91700a)
					{
						HX_STACK_LINE(59)
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","haxe/ds/StringMap.hx",60,0xea91700a)
					{
						HX_STACK_LINE(60)
