...
{
HX_STACK_FRAME("haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","haxe/ds/BalancedTree.hx",220,0x9adadae1)
HX_STACK_THIS(this)
HX_STACK_ARG(l,"l")
HX_STACK_ARG(k,"k")
HX_STACK_ARG(v,"v")
	...
	if (((h == (int)-1))){
		struct _Function_2_1{
			inline static int Block( hx::ObjectPtr< ::haxe::ds::TreeNode_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxe/ds/BalancedTree.hx",226,0x9adadae1)
				{
					HX_STACK_LINE(226)
