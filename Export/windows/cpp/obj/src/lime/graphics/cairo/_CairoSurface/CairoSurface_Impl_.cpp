...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("lime_buffer_get_native_pointer"),
	String(null()) };
...
void CairoSurface_Impl__obj::__boot()
{
	...
	lime_buffer_get_native_pointer= ::lime::system::System_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_buffer_get_native_pointer"),(int)1,null());
}
