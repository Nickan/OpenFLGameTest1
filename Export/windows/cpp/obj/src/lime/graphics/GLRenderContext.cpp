...
Dynamic GLRenderContext_obj::getActiveAttrib( ::lime::graphics::opengl::GLProgram program,int index){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getActiveAttrib",0x9cd2aba2,"lime.graphics.GLRenderContext.getActiveAttrib","lime/graphics/GLRenderContext.hx",754,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(program,"program")
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(754)
...
Dynamic GLRenderContext_obj::getActiveUniform( ::lime::graphics::opengl::GLProgram program,int index){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getActiveUniform",0x17ba49dc,"lime.graphics.GLRenderContext.getActiveUniform","lime/graphics/GLRenderContext.hx",761,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(program,"program")
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(761)
...
int GLRenderContext_obj::getAttribLocation( ::lime::graphics::opengl::GLProgram program,::String name){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getAttribLocation",0x7b35c211,"lime.graphics.GLRenderContext.getAttribLocation","lime/graphics/GLRenderContext.hx",775,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(program,"program")
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(775)
...
int GLRenderContext_obj::getBufferParameter( int target,int pname){
	...
	HX_STACK_LINE(782)
	return ::lime::graphics::opengl::GL_obj::lime_gl_get_buffer_parameter(target,pname);
}
...
Dynamic GLRenderContext_obj::getContextAttributes( ){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getContextAttributes",0xbf276074,"lime.graphics.GLRenderContext.getContextAttributes","lime/graphics/GLRenderContext.hx",789,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_LINE(789)
...
::String GLRenderContext_obj::getProgramInfoLog( ::lime::graphics::opengl::GLProgram program){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getProgramInfoLog",0xec189904,"lime.graphics.GLRenderContext.getProgramInfoLog","lime/graphics/GLRenderContext.hx",824,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(program,"program")
	HX_STACK_LINE(824)
...
int GLRenderContext_obj::getProgramParameter( ::lime::graphics::opengl::GLProgram program,int pname){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getProgramParameter",0xc6e7b177,"lime.graphics.GLRenderContext.getProgramParameter","lime/graphics/GLRenderContext.hx",831,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(program,"program")
	HX_STACK_ARG(pname,"pname")
	HX_STACK_LINE(831)
...
::String GLRenderContext_obj::getShaderInfoLog( ::lime::graphics::opengl::GLShader shader){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getShaderInfoLog",0x3434d1df,"lime.graphics.GLRenderContext.getShaderInfoLog","lime/graphics/GLRenderContext.hx",845,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(shader,"shader")
	HX_STACK_LINE(845)
...
int GLRenderContext_obj::getShaderParameter( ::lime::graphics::opengl::GLShader shader,int pname){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getShaderParameter",0x79281712,"lime.graphics.GLRenderContext.getShaderParameter","lime/graphics/GLRenderContext.hx",852,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(shader,"shader")
	HX_STACK_ARG(pname,"pname")
	HX_STACK_LINE(852)
...
Dynamic GLRenderContext_obj::getShaderPrecisionFormat( int shadertype,int precisiontype){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getShaderPrecisionFormat",0x3f8fb13e,"lime.graphics.GLRenderContext.getShaderPrecisionFormat","lime/graphics/GLRenderContext.hx",859,0xbdd53034)
	HX_STACK_THIS(this)
...
::String GLRenderContext_obj::getShaderSource( ::lime::graphics::opengl::GLShader shader){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getShaderSource",0xfeb4c3d2,"lime.graphics.GLRenderContext.getShaderSource","lime/graphics/GLRenderContext.hx",866,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(shader,"shader")
	HX_STACK_LINE(866)
...
Dynamic GLRenderContext_obj::getUniform( ::lime::graphics::opengl::GLProgram program,int location){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getUniform",0x81019082,"lime.graphics.GLRenderContext.getUniform","lime/graphics/GLRenderContext.hx",887,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(program,"program")
...
int GLRenderContext_obj::getUniformLocation( ::lime::graphics::opengl::GLProgram program,::String name){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","getUniformLocation",0x92a10cd7,"lime.graphics.GLRenderContext.getUniformLocation","lime/graphics/GLRenderContext.hx",894,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(program,"program")
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(894)
...
bool GLRenderContext_obj::isBuffer( ::lime::graphics::opengl::GLBuffer buffer){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","isBuffer",0x219a88ce,"lime.graphics.GLRenderContext.isBuffer","lime/graphics/GLRenderContext.hx",922,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(buffer,"buffer")
	HX_STACK_LINE(922)
...
bool GLRenderContext_obj::isFramebuffer( ::lime::graphics::opengl::GLFramebuffer framebuffer){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","isFramebuffer",0x26e6be5f,"lime.graphics.GLRenderContext.isFramebuffer","lime/graphics/GLRenderContext.hx",943,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(framebuffer,"framebuffer")
	HX_STACK_LINE(943)
...
bool GLRenderContext_obj::isProgram( ::lime::graphics::opengl::GLProgram program){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","isProgram",0x8805d2f6,"lime.graphics.GLRenderContext.isProgram","lime/graphics/GLRenderContext.hx",950,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(program,"program")
	HX_STACK_LINE(950)
...
bool GLRenderContext_obj::isRenderbuffer( ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","isRenderbuffer",0x698be724,"lime.graphics.GLRenderContext.isRenderbuffer","lime/graphics/GLRenderContext.hx",957,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(renderbuffer,"renderbuffer")
	HX_STACK_LINE(957)
...
bool GLRenderContext_obj::isShader( ::lime::graphics::opengl::GLShader shader){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","isShader",0x6e268af3,"lime.graphics.GLRenderContext.isShader","lime/graphics/GLRenderContext.hx",964,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(shader,"shader")
	HX_STACK_LINE(964)
...
bool GLRenderContext_obj::isTexture( ::lime::graphics::opengl::GLTexture texture){
	HX_STACK_FRAME("lime.graphics.GLRenderContext","isTexture",0x32ed514d,"lime.graphics.GLRenderContext.isTexture","lime/graphics/GLRenderContext.hx",971,0xbdd53034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(texture,"texture")
	HX_STACK_LINE(971)
...
void GLRenderContext_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_CSTRING("BGR_EXT"));
	outFields->push(HX_CSTRING("BGRA_EXT"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(GLRenderContext_obj,BGR_EXT),HX_CSTRING("BGR_EXT")},
	{hx::fsInt,(int)offsetof(GLRenderContext_obj,BGRA_EXT),HX_CSTRING("BGRA_EXT")},
