...
::lime::_backend::native::_NativeApplication::UpdateEventInfo UpdateEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.UpdateEventInfo","clone",0xc8041f71,"lime._backend.native._NativeApplication.UpdateEventInfo.clone","lime/_backend/native/NativeApplication.hx",694,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(694)
