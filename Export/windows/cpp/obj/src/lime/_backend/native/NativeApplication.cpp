...
Void NativeApplication_obj::create( Dynamic config){
{
		...
		if (((config != null()))){
			HX_STACK_LINE(59)
			this->setFrameRate(config->__Field(HX_CSTRING("fps"),true));
			HX_STACK_LINE(60)
...
Float NativeApplication_obj::getFrameRate( ){
	HX_STACK_FRAME("lime._backend.native.NativeApplication","getFrameRate",0xe79bf983,"lime._backend.native.NativeApplication.getFrameRate","lime/_backend/native/NativeApplication.hx",120,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(120)
...
{
		HX_STACK_FRAME("lime._backend.native.NativeApplication","handleGamepadEvent",0x54f9e7cd,"lime._backend.native.NativeApplication.handleGamepadEvent","lime/_backend/native/NativeApplication.hx",127,0xb13849fd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(127)
...
{
		HX_STACK_FRAME("lime._backend.native.NativeApplication","handleKeyEvent",0xe8484c0f,"lime._backend.native.NativeApplication.handleKeyEvent","lime/_backend/native/NativeApplication.hx",165,0xb13849fd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(165)
		if (((this->parent->windows->__get((int)0).StaticCast< ::lime::ui::Window >() != null()))){
			HX_STACK_LINE(167)
...
{
		HX_STACK_FRAME("lime._backend.native.NativeApplication","handleMouseEvent",0xe26e46c9,"lime._backend.native.NativeApplication.handleMouseEvent","lime/_backend/native/NativeApplication.hx",186,0xb13849fd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(186)
		if (((this->parent->windows->__get((int)0).StaticCast< ::lime::ui::Window >() != null()))){
			HX_STACK_LINE(188)
...
{
		HX_STACK_FRAME("lime._backend.native.NativeApplication","handleRenderEvent",0xf3931b50,"lime._backend.native.NativeApplication.handleRenderEvent","lime/_backend/native/NativeApplication.hx",218,0xb13849fd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(218)
...
{
		HX_STACK_FRAME("lime._backend.native.NativeApplication","handleTouchEvent",0xbe3236ef,"lime._backend.native.NativeApplication.handleTouchEvent","lime/_backend/native/NativeApplication.hx",275,0xb13849fd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(275)
		if (((this->parent->windows->__get((int)0).StaticCast< ::lime::ui::Window >() != null()))){
			HX_STACK_LINE(277)
...
{
		HX_STACK_FRAME("lime._backend.native.NativeApplication","handleWindowEvent",0x18b48476,"lime._backend.native.NativeApplication.handleWindowEvent","lime/_backend/native/NativeApplication.hx",310,0xb13849fd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(310)
		if (((this->parent->windows->__get((int)0).StaticCast< ::lime::ui::Window >() != null()))){
			HX_STACK_LINE(312)
...
Float NativeApplication_obj::setFrameRate( Float value){
	...
	HX_STACK_LINE(374)
	::lime::_backend::native::NativeApplication_obj::lime_application_set_frame_rate(this->handle,value);
	HX_STACK_LINE(375)
...
{
		HX_STACK_FRAME("lime._backend.native.NativeApplication","updateTimer",0x8a9bcb30,"lime._backend.native.NativeApplication.updateTimer","lime/_backend/native/NativeApplication.hx",382,0xb13849fd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(382)
...
Dynamic NativeApplication_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 23:
		...
		break;
	case 31:
		if (HX_FIELD_EQ(inName,"lime_application_set_frame_rate") ) { return lime_application_set_frame_rate; }
...
Dynamic NativeApplication_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 23:
		...
		break;
	case 31:
		if (HX_FIELD_EQ(inName,"lime_application_set_frame_rate") ) { lime_application_set_frame_rate=inValue.Cast< Dynamic >(); return inValue; }
...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("lime_application_set_frame_rate"),
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsFloat,(int)offsetof(NativeApplication_obj,frameRate),HX_CSTRING("frameRate")},
...
void NativeApplication_obj::__boot()
{
	...
	lime_application_set_frame_rate= ::lime::system::System_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_application_set_frame_rate"),(int)2,null());
