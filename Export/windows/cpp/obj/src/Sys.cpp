...
{
		HX_STACK_FRAME("Sys","print",0x483745ec,"Sys.print","Sys.hx",25,0x2741eff1)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(25)
		::__hxcpp_print(v);
	}
...
{
		HX_STACK_FRAME("Sys","println",0x3905f76e,"Sys.println","Sys.hx",28,0x2741eff1)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(29)
		::Sys_obj::print(v);
		HX_STACK_LINE(30)
...
Array< ::String > Sys_obj::args( ){
	HX_STACK_FRAME("Sys","args",0xeaeddc7e,"Sys.args","Sys.hx",50,0x2741eff1)
	HX_STACK_LINE(50)
	return ::__get_args();
}
...
{
		HX_STACK_FRAME("Sys","exit",0xed97463f,"Sys.exit","Sys.hx",108,0x2741eff1)
