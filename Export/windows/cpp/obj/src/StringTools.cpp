...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_FRAME("StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","StringTools.hx",71,0x046ae594)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(71)
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_FRAME("StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","StringTools.hx",133,0x046ae594)
	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::hex( int n,Dynamic digits){
	HX_STACK_FRAME("StringTools","hex",0xd91debd7,"StringTools.hex","StringTools.hx",313,0x046ae594)
	HX_STACK_ARG(n,"n")
