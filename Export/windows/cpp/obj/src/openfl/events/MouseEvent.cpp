...
::openfl::events::Event MouseEvent_obj::clone( ){
	HX_STACK_FRAME("openfl.events.MouseEvent","clone",0x3e8b341b,"openfl.events.MouseEvent.clone","openfl/events/MouseEvent.hx",338,0xd3783172)
	HX_STACK_THIS(this)
	HX_STACK_LINE(338)
	...
	HX_STACK_ARG(delta,"delta")
{
		...
		if (  ( _switch_1==::openfl::events::MouseEvent_obj::MOUSE_DOWN)){
			HX_STACK_LINE(316)
			::openfl::events::MouseEvent_obj::__buttonDown = true;
		}
		else if (  ( _switch_1==::openfl::events::MouseEvent_obj::MOUSE_UP)){
			HX_STACK_LINE(320)
...
;
		HX_STACK_LINE(326)
		::openfl::events::MouseEvent event = ::openfl::events::MouseEvent_obj::__new(type,true,false,local->x,local->y,null(),::openfl::events::MouseEvent_obj::__ctrlKey,::openfl::events::MouseEvent_obj::__altKey,::openfl::events::MouseEvent_obj::__shiftKey,::openfl::events::MouseEvent_obj::__buttonDown,delta,::openfl::events::MouseEvent_obj::__commandKey,null());		HX_STACK_VAR(event,"event");
		HX_STACK_LINE(327)
		event->stageX = stageX;
		HX_STACK_LINE(328)
		event->stageY = stageY;
...
Dynamic MouseEvent_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"__buttonDown") ) { __buttonDown=inValue.Cast< bool >(); return inValue; }
