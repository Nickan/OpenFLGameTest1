...
bool Listener_obj::match( Dynamic callback,bool useCapture){
	HX_STACK_FRAME("openfl.events._EventDispatcher.Listener","match",0xdf4e17e0,"openfl.events._EventDispatcher.Listener.match","openfl/events/EventDispatcher.hx",500,0xe2270714)
	HX_STACK_THIS(this)
	HX_STACK_ARG(callback,"callback")
	HX_STACK_ARG(useCapture,"useCapture")
	HX_STACK_LINE(500)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.events._EventDispatcher.Listener"), hx::TCanCast< Listener_obj> ,sStaticFields,sMemberFields,
