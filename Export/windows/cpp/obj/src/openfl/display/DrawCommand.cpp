...
::openfl::display::DrawCommand  DrawCommand_obj::DrawPathC(Array< int > commands,Array< Float > data,::openfl::display::GraphicsPathWinding winding)
	{ return hx::CreateEnum< DrawCommand_obj >(HX_CSTRING("DrawPathC"),17,hx::DynamicArray(0,3).Add(commands).Add(data).Add(winding)); }
...
::openfl::display::DrawCommand  DrawCommand_obj::LineBitmapStyle(::openfl::display::BitmapData bitmap,::openfl::geom::Matrix matrix,bool repeat,bool smooth)
	{ return hx::CreateEnum< DrawCommand_obj >(HX_CSTRING("LineBitmapStyle"),13,hx::DynamicArray(0,4).Add(bitmap).Add(matrix).Add(repeat).Add(smooth)); }

::openfl::display::DrawCommand  DrawCommand_obj::LineGradientStyle(::openfl::display::GradientType type,Dynamic colors,Dynamic alphas,Dynamic ratios,::openfl::geom::Matrix matrix,::openfl::display::SpreadMethod spreadMethod,::openfl::display::InterpolationMethod interpolationMethod,Dynamic focalPointRatio)
	{ return hx::CreateEnum< DrawCommand_obj >(HX_CSTRING("LineGradientStyle"),14,hx::DynamicArray(0,8).Add(type).Add(colors).Add(alphas).Add(ratios).Add(matrix).Add(spreadMethod).Add(interpolationMethod).Add(focalPointRatio)); }
...
::openfl::display::DrawCommand  DrawCommand_obj::LineTo(Float x,Float y)
	{ return hx::CreateEnum< DrawCommand_obj >(HX_CSTRING("LineTo"),15,hx::DynamicArray(0,2).Add(x).Add(y)); }

::openfl::display::DrawCommand  DrawCommand_obj::MoveTo(Float x,Float y)
	{ return hx::CreateEnum< DrawCommand_obj >(HX_CSTRING("MoveTo"),16,hx::DynamicArray(0,2).Add(x).Add(y)); }

::openfl::display::DrawCommand  DrawCommand_obj::OverrideMatrix(::openfl::geom::Matrix matrix)
	{ return hx::CreateEnum< DrawCommand_obj >(HX_CSTRING("OverrideMatrix"),18,hx::DynamicArray(0,1).Add(matrix)); }
...
int DrawCommand_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_CSTRING("DrawPathC")) return 17;
	...
	if (inName==HX_CSTRING("LineBitmapStyle")) return 13;
	if (inName==HX_CSTRING("LineGradientStyle")) return 14;
	if (inName==HX_CSTRING("LineStyle")) return 12;
	if (inName==HX_CSTRING("LineTo")) return 15;
	if (inName==HX_CSTRING("MoveTo")) return 16;
	if (inName==HX_CSTRING("OverrideMatrix")) return 18;
...
int DrawCommand_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_CSTRING("LineBitmapStyle")) return 4;
	if (inName==HX_CSTRING("LineGradientStyle")) return 8;
...
Dynamic DrawCommand_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	if (inName==HX_CSTRING("LineBitmapStyle")) return LineBitmapStyle_dyn();
	if (inName==HX_CSTRING("LineGradientStyle")) return LineGradientStyle_dyn();
