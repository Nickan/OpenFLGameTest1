...
Void GLBitmap_obj::render( ::openfl::display::Bitmap bitmap,::openfl::_internal::renderer::RenderSession renderSession){
{
		...
		HX_STACK_LINE(18)
		renderSession->spriteBatch->renderBitmapData(bitmap->bitmapData,bitmap->smoothing,bitmap->__worldTransform,bitmap->__worldColorTransform,bitmap->__worldAlpha,bitmap->__blendMode,bitmap->pixelSnapping,null());
	}
return null();
}
