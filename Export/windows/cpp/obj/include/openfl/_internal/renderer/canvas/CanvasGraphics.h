...
class HXCPP_CLASS_ATTRIBUTES  CanvasGraphics_obj : public hx::Object{
	...
	public:
		...
		static Void createGradientPattern( ::openfl::display::GradientType type,Dynamic colors,Dynamic alphas,Dynamic ratios,::openfl::geom::Matrix matrix,::openfl::display::SpreadMethod spreadMethod,::openfl::display::InterpolationMethod interpolationMethod,Dynamic focalPointRatio);
